...
export default function FurniturePanel({
  ...
  return (
    <div className={`bg-muted/50 border border-border rounded-xl p-4 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-foreground">Add Objects</h3>
            <p className="text-[11px] text-muted-foreground">Place 3D models in your scene</p>
          </div>
        </div>
      ...
      {furniture.length === 0 && !isLoading && (
        <div className="mt-4 pt-4 border-t border-border text-center py-4">
          <p className="text-xs text-muted-foreground">
            No objects added yet. Upload a GLB file or paste a URL to get started.
          </p>
        </div>
      )}
    </div>
